...
func printHelp() {
	fmt.Println("Helstare OS (Based OneAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
...
func InitEnv() {
	...
	if os.Getenv("CRYPTO_SECRET") != "" {
		...
		if len(CryptoSecret) < 32 {
			log.Fatal("CRYPTO_SECRET must be at least 32 characters long.")
		}
	} else {
