...
func registerChannelRoutes(apiRouter *gin.RouterGroup) {
	...
	// Channel listings and non-secret operations are part of the admin console.
	// Sensitive key access remains explicitly protected by RootAuth below.
	channelRoute.Use(middleware.AdminAuth())
	channelRoute.Use(middleware.CSRFProtection()) // CSRF保护所有渠道管理操作
