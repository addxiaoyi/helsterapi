...
func InitOptionMap() {
	...
	common.OptionMap["LeakProtectionBalancedForceEnabled"] = strconv.FormatBool(common.LeakProtectionBalancedForceEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "LeakProtectionBalancedForceEnabled":
			common.LeakProtectionBalancedForceEnabled = boolValue
