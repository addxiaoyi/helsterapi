...
func SendEmailVerification(c *gin.Context) {
	...
	content, err := common.RenderVerificationEmail(common.SystemName, code, common.VerificationValidMinutes)
	if err != nil {
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if _, err := model.GetUniqueUserByEmail(email); err == nil {
		...
		content, renderErr := common.RenderPasswordResetEmail(common.SystemName, link, common.VerificationValidMinutes)
		if renderErr != nil {
			logger.LogError(c.Request.Context(), fmt.Sprintf("failed to render password reset email for %s: %s", email, renderErr.Error()))
		} else if err := common.SendEmail(subject, email, content); err != nil {
