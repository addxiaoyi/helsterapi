# Helstare OS Electron Desktop App

This directory contains the Electron wrapper for Helstare OS, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/Helstare OS/data/`
  - Windows: `%APPDATA%/Helstare OS/data/`
  - Linux: `~/.config/Helstare OS/data/`
